//
//  WineActivitySelectedWineViewController.m
//  食全酒美
//
...
@interface WineActivitySelectedWineViewController ()

@end

@implementation WineActivitySelectedWineViewController
@synthesize delegate;
...
- (void)viewDidLoad
{
    ...
    [rightBtn setImage:[UIImage imageNamed:@"SelectedAllUnClicked.png"] forState:UIControlStateNormal];
    [rightBtn setImage:[UIImage imageNamed:@"SelectedAllClicked.png"] forState:UIControlStateHighlighted];
    [rightBtn addTarget:self action:@selector(SelectedAll) forControlEvents:UIControlEventTouchUpInside];
...
-(void)SelectedAll
{
    [self.delegate SelectedAtIndex:0 :0];
}

//
//  ShopDetailActivityViewController.m
//  食全酒美
//
...
@interface ShopDetailActivityViewController ()

@end

@implementation ShopDetailActivityViewController
@synthesize mShopId;
...
- (void)viewDidLoad
{
    ...
    [dataHandler ShopEventListRequestRecord:mShopId :mPageNum*10 :(mPageNum+1)*10 :self];

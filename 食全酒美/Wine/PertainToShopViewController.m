...
#import "ShopCell.h"
@interface PertainToShopViewController ()

@end

@implementation PertainToShopViewController
...
- (void)viewDidLoad
{
    ...
    [dataHandler WinePertainToShopListRecord:pagenum*10 :(pagenum+1)*10 :mwineId :self];
...
//    }
//    cell.textLabel.text = [(NSDictionary*)[mShopArray objectAtIndex:indexPath.row] objectForKey:@"shop_name"];
